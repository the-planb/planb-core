...
final class CanonicalPathTest extends TestCase
{
    ...
    public static function familyProvider(): array
    {
        return [
            ...
            'Linux: Un stream debe ser válido' => [Family::Linux, 'vfs://var/www/html/drive/file.php', null],
            ...
            'Windows: Un stream debe fallar' => [Family::Windows, 'vfs://var/www/html/drive/file.php', null],
