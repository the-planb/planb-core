...
final class CanonicalPathTest extends TestCase
{
    ...
    #[Test]
    #[DataProvider('homeDirectoryProvider')]
    public function it_resolves_home_directory_shortcut(string $path, string $expected): void
    {
        $canonicalPath = new CanonicalPath();
        $resolved = $canonicalPath->resolve($path);

        self::assertSame($expected, $resolved);
    }


    public static function homeDirectoryProvider(): array
    {
        return [
            'relative path' => ['~/documents/invoice.pdf', getenv('HOME') . '/documents/invoice.pdf'],
    ...
    public function it_fails_with_colons_only_on_non_windows_systems(
        Family $family,
        string $input,
        ?string $exception
    ): void {
    ...
    {
        return [
            'Linux: Letra de unidad simulada debe fallar' => [
                Family::Linux,
                'C:\app\src\file.php',
                InvalidPathException::class
            ],
            'Linux: Un stream debe ser válido' => [
                Family::Linux,
                'vfs://var/www/html/drive/file.php',
                null
            ],
            'Linux: Un stream, con barras extra, debe ser válido' => [
                Family::Linux,
                'vfs://var/www/html/drive//',
                null
            ],
            'Linux: Dos puntos en cualquier otra posición debe fallar' => [
                Family::Linux,
                '/var/www/html/drive:file.php',
                InvalidPathException::class
            ],
            'Solaris: Dos puntos en cualquier posición debe fallar' => [
                Family::Solaris,
                '/etc/init.d/service:daemon',
                InvalidPathException::class
            ],
            'Windows: Letra de unidad estándar válida' => [
                Family::Windows,
                'C:\app\src\file.php',
                null
            ],
            'Windows: Un stream debe fallar' => [
                Family::Windows,
                'vfs://var/www/html/drive/file.php',
                null
            ],
            'Windows: Letra de unidad en minúscula válida' => [
                Family::Windows,
                'd:\project\index.php',
                null
            ],
            'Windows: Ruta UNC sin dos puntos válida' => [
                Family::Windows,
                '\\\server\share\file.txt',
                null
            ],
            'Windows: Ruta relativa sin dos puntos válida' => [
                Family::Windows,
                'src\Core\Path.php',
                null
            ],
            'Windows: Múltiples dos puntos debe fallar' => [
                Family::Windows,
                'C:\path:\to\file.php',
                InvalidPathException::class
            ],
            'Windows: Dos puntos mal ubicados al final debe fallar' => [
                Family::Windows,
                'C:\path\to\:file.php',
                InvalidPathException::class
            ],
            'Windows: Dos puntos en posición incorrecta sin unidad válida' => [
                Family::Windows,
                '\path\to:file.php',
                InvalidPathException::class
            ],
            'Windows: Carácter numérico como unidad de disco debe fallar' => [
                Family::Windows,
                '1:\path\to\file.php',
                InvalidPathException::class
            ],
            'Windows: Carácter especial como unidad de disco debe fallar' => [
                Family::Windows,
                '&:\path\to\file.php',
                InvalidPathException::class
            ],
